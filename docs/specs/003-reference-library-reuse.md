...
Backend `8290002` aplicado y validado en Supabase el 13 de agosto de 2026.
Preflight: 3 usos activos y 0 grupos duplicados. La prueba transaccional cerró
con `backend_v1 QA passed`.
